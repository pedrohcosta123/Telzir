...
<body>
    <div class="container">
        ...
        <div class="col-md-12 order-md-1">
            <form class="needs-validation" action="{{route('destino')}}">
                <div class="row">
                    <div class="col-md-4 mb-3">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label>Selecione o DDD de Origem</label>
                        <select class="custom-select d-block w-100" name="id">
                    ...
                    <div class="col-md-4 mb-3">
                        <input type="submit" value="Próximo" class="btn btn-primary btn-lg"> 
                    </div>
                </div>
            </form>
        </div>
